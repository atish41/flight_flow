...
url = "https://goagentgomarket.vgtechdemo.com/api/revalidate-flight"
def revalidate_flight(group_ind, unique_ref_no, flight_id, trip_type, from_city, to_city, depart_date, return_date, adults, children, infants, cabin_class, currency, api, session_id):
...
# Example usage
message= revalidate_flight(
    group_ind=1,
    unique_ref_no="EC2AH4Z58419",
    flight_id=0,
    trip_type="R",
    from_city="Hong Kong, Hong Kong - Hong Kong International (ATL)",
    to_city="Tokyo, Japan - New Tokyo International Airport (DXB)",
    ...
    currency="NGN",
    api="sabre",
    session_id="XOOUy8cbTOyQJLd0JBJwOw",
...
# message= revalidate_flight(
#     group_ind=1,
#     unique_ref_no="oW93YECH41034",
#     flight_id=1,
#     trip_type="R",
#     from_city="Hong Kong, Hong Kong - Hong Kong International (DEL)",
#     to_city="Tokyo, Japan - New Tokyo International Airport (BOM)",
#     depart_date="2024-10-02",
#     return_date="2024-10-11",
#     adults=1,
#     children=1,
#     infants=0,
#     cabin_class="Y",
#     currency="NGN",
#     api="sabre",
#     session_id="IdsX0LLy2wTXeEozaJ_SR01g",
#     # token="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..5FXSjEzahb8Kpum6mwXc0tnM7RgOasRJcuuCiCx4j2g"
# )
